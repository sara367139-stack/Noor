...
import 'package:noorah/features/setup/user_setup_page.dart';
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/setup', builder: (context, state) => const UserSetupPage()),
    GoRoute(path: '/quran', builder: (context, state) => const QuranPage()),

    GoRoute(path: '/dhikr', builder: (context, state) => DhikrPage()),
    ...
    GoRoute(path: '/rate', builder: (context, state) => const RatePage()),
